...
# DenonTelnet V0.0
# ================
# Written by Nick Card, <nick@nicholascard.com> 
#
# Modified from DenonSerial V0.6, written by Oliver Wagner, <owagner@hometheatersoftware.com>
#
# Revision history:
# -----------------
# 0.1 - initial
...
help = """\
Small trivial plugin to control Denon AVRs and AMPs via Telnet.
Developed and tested with an AVR X2200W only, but might work with
...
"AVR3312CI_AVR3312_PROTOCOL_V7.6.0.pdf", which is available 
from the Denon websites.
